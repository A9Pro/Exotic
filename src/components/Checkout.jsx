...
export default function Checkout({ cartItems, total, onBack, onOrderSuccess }) {
    ...
    return (
      ...
      >
        <div className="text-center px-6 py-12 max-w-md">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">Thank you! Your order has been received.</p>
    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm">
        <div className="flex items-center px-5 py-4">
          <button 
            onClick={onBack} 
            className="p-2 -ml-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300"
          >
            <ArrowLeft size={22} />
          </button>
      ...
      <div className="p-5 space-y-6 pb-20">
        ...
        {step === 1 && (
          <Card className="p-6 shadow-sm border border-gray-200 dark:border-gray-800">
            <h2 className="text-xl font-semibold mb-6 flex items-center gap-3 text-gray-900 dark:text-white">
              <User size={22} className="text-rose-600 dark:text-rose-400" /> Customer Information
            </h2>
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  } bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-rose-500 focus:ring-2 focus:ring-rose-200 dark:focus:ring-rose-800/40 outline-none`}
        ...
        {step === 2 && (
          <Card className="p-6 shadow-sm border border-gray-200 dark:border-gray-800">
            <h2 className="text-xl font-semibold mb-6 flex items-center gap-3 text-gray-900 dark:text-white">
              <MapPin size={22} className="text-rose-600 dark:text-rose-400" /> Delivery Location
            </h2>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.city}
                  onChange={handleChange}
                  className="w-full px-4 py-3.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-rose-500 focus:ring-2 focus:ring-rose-200 dark:focus:ring-rose-800/40 outline-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full px-4 py-3.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-rose-500 focus:ring-2 focus:ring-rose-200 dark:focus:ring-rose-800/40 outline-none resize-none"
            ...
            <Card className="p-6 shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between text-sm pt-3 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <span className={deliveryFee === 0 ? "text-green-600 dark:text-green-400 font-medium" : "text-rose-600 dark:text-rose-400"}>
